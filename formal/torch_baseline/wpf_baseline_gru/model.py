...
class BaselineGruModel(nn.Module):
    ...
    def __init__(self, settings):
        ...
        self.lstm = nn.GRU(input_size=self.hidC, hidden_size=self.hidR, num_layers=settings["lstm_layer"],batch_first=False)
